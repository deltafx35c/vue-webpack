...
var calendar = {
    ...
    /**
      ...
      */
    lunarToSolar:function(y,m,d,isLeapMonth) {   //参数区间1900.1.31~2100.12.1
...
var vueCalendar = {}
vueCalendar.install = function(Vue,options){
    Vue.prototype.$calendar = calendar;
}

if (typeof module !== "undefined" && module.exports) {
    module.exports = vueCalendar;
} else if (typeof define === "function" && define.amd) {
    define(function(){return vueCalendar;});
} else if (window.Vue){
    window.VueCalendar = vueCalendar;
    Vue.use(vueCalendar)
} else if (window){
